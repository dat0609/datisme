...
<html lang="en">
    ...
    <head>
        ...
        <title>The Collector - Dashboard</title>
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                    Earnings (Annual)</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">${requestScope.totalMoney}</div>
                                            </div>
                                            <div class="col-auto">
                                        ...
                                        <ul class="pagination pagination-lg">
                                            <c:forEach begin="1" end="${totalPage}" var="i"> 
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <li class="page-item"><a class="page-link" href="admin?pageIndex=${i}">${i}</a></li>
                                                        </c:otherwise>
                                                    </c:choose>
